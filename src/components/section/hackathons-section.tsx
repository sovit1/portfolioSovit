...
import { Timeline, TimelineItem, TimelineConnectLine } from "@/components/timeline";
      ...
      <div className="flex min-h-0 flex-col gap-y-8">
        ...
        <Timeline>
          {DATA.hackathons.map((hackathon) => (
            <TimelineItem key={hackathon.title + hackathon.dates}>
              <TimelineConnectLine x={-44} />

              <div className="absolute -left-16 top-0 flex items-center justify-center bg-card z-10">
                {hackathon.image ? (
                  <img
                    src={hackathon.image}
                    alt={hackathon.title}
